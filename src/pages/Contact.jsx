...
const contacts = [
  {
    icon: Github,
    label: 'GitHub',
    value: 'github.com/shalinisenthilkumar2021-cmyk',
    href: 'https://github.com/shalinisenthilkumar2021-cmyk',
    color: '#f0f0f0',
  ...
  },
  {
    ...
    href: 'mailto:shalinisenthilkumar2021@gmail.com',
    color: '#7c6af7',
